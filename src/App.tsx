...
export default function App(): React.ReactElement {
  ...
  // M13.5.4: mounted volumes for the sidebar Disk widget. Same slow
  // tier as interfaces / battery / IP because volumes come and go
  // from user action (mount / unmount / drive eject) rather than
  // continuously. The `disk_volumes()` probe already filters system
  // infrastructure (Preboot / VM / tmpfs / cgroup etc.) in Rust —
  // whatever reaches this state is what the user wants to see.
